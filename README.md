...
PATCH /api/v1/banner
Headers: Authorization: Bearer {token}
Body: { id: number, sort: number }
```

#### 上传轮播图
```
POST /api/v1/banner/upload
Headers: Authorization: Bearer {token}
...
### 待完善功能 🚧
- [ ] 餐品列表查询接口（GET /api/v1/meals）
- [ ] 管理后台订单管理（查看所有订单、订单统计、筛选）
- [ ] 日志管理功能完善
- [ ] 数据统计接口

## ⚠️ 免责声明

本项目仅供个人学习与研究使用。请勿将本项目用于任何商业用途或违法用途。若产生法律纠纷，作者不承担任何责任。
